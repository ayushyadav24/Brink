...
class SelectSubjectNotes extends StatefulWidget {
  const SelectSubjectNotes({Key? key}) : super(key: key);

  @override
  _SelectSubjectState createState() => _SelectSubjectState();
}

class _SelectSubjectState extends State<SelectSubjectNotes> {
          ...
          child: Column(
            ...
            children: [
              SizedBox(
                ...
                child: Image.asset(
                  'assets/Notes_Share.jfif', // Path to your image file
              ...
              ElevatedButton(
                onPressed: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => const ShareNotesScreen()),
                  );
                },
...
class ShareNotesScreen extends StatelessWidget {
  const ShareNotesScreen({super.key});
  @override
  Widget build(BuildContext context) {
                ...
                child: Container(
                  ...
                  decoration: const BoxDecoration(
                      image: DecorationImage(
                          image: AssetImage("assets/Notes_Share.jfif")
                      )
                  ),
                ),
              ),
